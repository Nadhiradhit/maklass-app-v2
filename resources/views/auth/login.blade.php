...
<x-layouts.layout-auth>
    <div class="flex flex-col-reverse md:flex-row items-stretch justify-center w-full max-w-6xl min-h-[500px] md:min-h-[600px] lg:min-h-[700px] transition-opacity opacity-100 duration-750 starting:opacity-0 border border-gray-100 rounded-xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.06)]">
        <!-- Form section -->
