...
@section('content')
    <div class="px-3 sm:px-4 lg:px-6 py-4 sm:py-6 md:py-8 mx-auto ">
        <div class="flex flex-col md:flex-row items-center justify-between mb-4">
            ...
            <div class="mt-4 sm:mt-0 w-full md:w-1/3">
                <form action="{{ route('landing.user.schedule.dashboard') }}" method="GET" class="flex flex-col space-x-2">
                    <label for="semester_id" class="sr-only">Pilih Semester</label>
